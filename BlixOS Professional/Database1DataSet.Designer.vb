...
Partial Public Class Database1DataSet
    ...
    Partial Public Class Table1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddTable1Row(ByVal Field1 As String, ByVal Field2 As String) As Table1Row
            Dim rowTable1Row As Table1Row = CType(Me.NewRow,Table1Row)
            Dim columnValuesArray() As Object = New Object() {Nothing, Field1, Field2}
    ...
    Partial Public Class Table1Row
        ...
        Public Function IsField2Null() As Boolean
            Return Me.IsNull(Me.tableTable1.Field2Column)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetField2Null()
            Me(Me.tableTable1.Field2Column) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class Table1TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`ID` = ?) AND ((? = 1 AND `Field1` IS NULL) OR (`Fie"& _ 
                "ld1` = ?)) AND ((? = 1 AND `Field2` IS NULL) OR (`Field2` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`Field1`, `Field2`) VALUES (?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `Field1` = ?, `Field2` = ? WHERE ((`ID` = ?) AND ((? = 1 AND "& _ 
                "`Field1` IS NULL) OR (`Field1` = ?)) AND ((? = 1 AND `Field2` IS NULL) OR (`Fiel"& _ 
                "d2` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.BlixOS_Professional.My.MySettings.Default.an
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Field1, Field2 FROM Table1"
